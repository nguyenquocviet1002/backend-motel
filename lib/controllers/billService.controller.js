...
export const createAllBillForHouse = async (req, res) => {
  ...
  try {
    ...
    if (checkDataNextMonth.length > 0) {
      const newNew = checkDataNextMonth.map((itemA) => {
        data.map((itemB) => {
          // console.log('itemA', itemA);

          // console.log('itemB', itemB);
          // console.log('itemA.idRoom.toString() == itemB.idRoom', itemA.idRoom.toString() == itemB.idRoom);
          // console.log('itemA.name == itemB.name', itemA.name == itemB.name);
          // console.log('itemA.inputValue == 0', itemA.inputValue == 0);
          // console.log('itemA.outputValue == 0', itemA.outputValue == 0);
          return itemA == itemB.name &&
            itemA.idRoom.toString() == itemB.idRoom &&
            itemA.inputValue == 0 &&
            itemA.outputValue == 0
            ? itemA
            : undefined;
