...
export const createAllBillForHouse = async (req, res) => {
  ...
  try {
    ...
    //     data.map((itemB) => {
    //       if (itemA.idRoom == itemB.idRoom) {
    //         if (itemA.inputValue == 0 && itemA.outputValue == 0) {
    //           co;
    //           const newDataNewMonth = { itemA, outputValue: itemB.outputValue };
    //           console.log('newDataNewMonth', newDataNewMonth);

    //           return newDataNewMonth;
    //         } else {
    //           return { ...itemA };
    //         }
    //       }
